...
if st.session_state.page == "about":
    ...
    st.markdown(
        """
        ### 📌 Overview
        ***Singapore Food Licence AI*** is a web-based assistant that helps food entrepreneurs, retailers, and import/export businesses understand which regulatory approvals and licences they need in Singapore.
        
        Imagine you are an entrepreneur excited to start selling your grandmother's recipe. Instead of searching through multiple agencies and struggling with technical jargon or forms that don't recognise local terms like "zi char", "biryani", "煎饼", "nasi padang", or "BBT" you can describe your business naturally. Singapore Food Licence AI interprets these everyday terms and maps them to the correct regulatory categories, and give you the relevant licensing requirements.
        
        Built on comprehensive data covering licensing, permits, and registrations from multiple government agencies including SFA, SPF, MUIS, NEA, and others, the AI-powered platform delivers accurate, contextualised advice in plain English quickly. Simply describe your food business idea using familiar local terms, and the assistant provides step-by-step guidance on exactly which licences you need, from which agencies, and in what sequence. 
